...
const Login = () => {
  ...
  return (
    <section className='px-5 lg:px-0 min-h-[calc(100vh-150px)] flex items-center justify-center'>
      <div className='w-full max-w-[570px] mx-auto rounded-lg shadow-panelShadow md:p-10'>
        ...
        <form className='py-4 md:py-0' onSubmit={submitHandler}>
          ...
          <div className='mt-7'>
            <button type='submit' className='w-full bg-blue-500 text-white leading-[30px] rounded-lg px-4 py-3' disabled={loading}>
